        ...
        <div className="rules">
            <div className="top">
                ...
                <div className="pieces">
                    ...
                    <div className="white"><img src={ PawnW } alt="white pawn" /></div>
                </div>
            </div>
            ...
            <div className="middle">
                <div className="carrier">
                    <div className="grey-space">
                        <div className="image"><img src={ Pawn } alt="pawn" /></div>
                    </div>
                    <div className="white-space">
                        <h4>Pawn</h4>
                        <p>Can only move once after making the first move.
                        First move is either once or twice.</p>
                    </div>
                </div>

                <div className="carrier">
                    <div className="grey-space">
                        <div className="king"><img src={ King } alt="King" /></div>
                    </div>
                    <div className="white-space">
                        <h4>King</h4>
                ...
                <div className="carrier">
                    <div className="grey-space">
                        <div className="image"><img src={ Rook } alt="Rook" /></div>
                    </div>
                    <div className="white-space">
                        <h4>Rook</h4>
                        <p>Moves straight horizontally or vertically and can move as far as its line of sight.</p>
                    </div>
                </div>

                <div className="carrier">
                    <div className="grey-space">
                        <div className="image"><img src={ Bishop } alt="Bishop" /></div>
                    </div>
                    <div className="white-space">
                        <h4>Bishop</h4>
                ...
                <div className="carrier">
                    <div className="grey-space">
                        <div className="queen"><img src={ Queen } alt="Queen" /></div>
                    </div>
                    <div className="white-space">
                        <h4> Queen</h4>
                ...
                <div className="carrier">
                    <div className="grey-space">
                        <div className="image"><img src={ Knight } alt="Knight" /></div>
                    </div>
                    <div className="white-space">
                        <h4>Knight</h4>
                        <p>Moves in an L-shape: 2 up 1 left or 1 up 2 left or right and can move over a piece.</p>
                    </div>
                </div>
            </div>
