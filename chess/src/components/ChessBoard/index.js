...
function ChessBoard({ type, gameData }) {
	...
	useEffect(() => {
		...
		GameEngine.current = new Chess((gameData.moves.length > 0) ? gameData.moves.at(-1).position_fen : "");
			...
			<div className="chessboard">
				...
				>
					...
					<Chessboard
						...
						orientation={players_to_color_map[getLoggedInUserData().user_id] == 'b' ? 'black' : 'white'}
