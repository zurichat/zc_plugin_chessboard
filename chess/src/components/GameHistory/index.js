            ...
            {games.map((item) => (
              <div>
                ...
                {item.status === 0 ? null : (
                  <div>
                    <img
                      className={styles["game_img_owner"]}
                      src={item.owner.image_url}
                    />
                    <img
                      className={styles["game_img_opponent"]}
                      src={item.opponent.image_url}
                    />
                    <br />
                    <span className={styles["game_data"]}>
                    ...
                    <span className={styles["game_data"]}>
                      {" "}
                      <p className={styles["chess_color"]}>
                        Chess Color{" "}
                      </p>( {item.owner.color} ) -----
                      <p className={styles["chess_color"]}>
                        {" "}
                        Chess Color{" "}
                      </p> ( {item.opponent.color} )
                    </span>
