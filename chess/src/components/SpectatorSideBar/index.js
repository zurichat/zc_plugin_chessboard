...
const SpectatorSideBar = ({ type, gameData }) => {
    ...
    const [commentsFromGameData, setCommentsFromGameData] = useState(gameData.messages);
            ...
            <aside className="side-bar">
                ...
                <div id="chat">
                    <div className="chatContainer">
                        {commentsFromGameData.length ? commentsFromGameData.map(({ user_name, image_url, text, timestamp }) => {
                            return (
