              ...
              <div key={item._id}>
                ...
                {item.status === 0 ? null : (
                  <div>
                    ...
                    <br />
                    <span className={styles.game_data}>
                      {item.owner.user_name} ------------- {item.opponent.user_name}
                    </span>
                    <span className={styles.game_data}>
                      {' '}
                      <p className={styles.chess_color}>Chess Color </p>({item.owner.color} ) -----
                      <p className={styles.chess_color}> Chess Color </p> ({item.opponent.color} )
                    </span>
