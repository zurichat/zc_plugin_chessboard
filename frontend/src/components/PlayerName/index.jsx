    ...
    return (
      <>
        <WaitingPlayer2Container className="waiting_player_2_container" onClick={handleInviteModal}>
          <button type="button" className="waiting_player_2">
            {' '}
            Waiting for player
          </button>
        </WaitingPlayer2Container>

        <InviteUser isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} gameData={gameData} />
      </>
    );
  }
